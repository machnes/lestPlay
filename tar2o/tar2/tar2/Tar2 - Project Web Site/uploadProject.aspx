...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <p style="font-size: large; text-align: center;">
        ...
        Please fill in the project details:</p>
        ...
        <div style="float: left; width: 85%">
            <div class="form-container">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="shortdescriptiontxt"
                    ErrorMessage="* This field is a must" ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:Button ID="Button1" class="submit-button" runat="server" Text="Next" OnClick="Button1_Click" /><br />
                <br />
            ...
            <%-- Description:
                ...
                <asp:TextBox ID="shortdescriptiontxt" runat="server" TextMode="MultiLine"></asp:TextBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator54" runat="server" ControlToValidate="shortdescriptiontxt"
                    ErrorMessage="* This field is a must" ForeColor="Red"></asp:RequiredFieldValidator>
            --%>
        </div>
    ...
    <asp:Panel ID="Panel7" runat="server">
        ...
        <div style="float: left; width: 85%">
            <div class="form-container">
                ...
                <br />
                <br />
                <asp:Button ID="submitBTN"  class="submit-button" runat="server" Text="Upload Project" OnClick="submitBTN_Click"
